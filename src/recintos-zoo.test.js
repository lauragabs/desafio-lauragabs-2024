...
describe('Recintos do Zoologico', () => {
    ...
    // Testes extras para validação de todos os cenários

    test('Somente colocar carnivoros da mesma especie', () => {
        const resultado = new RecintosZoo().analisaRecintos('LEOPARDO', 1);
        expect(resultado.erro).toBe("Não há recinto viável");
        expect(resultado.recintosViaveis).toBeFalsy();
    });

    test('Deve colocar Leao onde ja tem Leao', () => {
    ...
    test('Deve colocar Hipopotamo com outra especie onde tem savana e rio, e sozinho', () => {
